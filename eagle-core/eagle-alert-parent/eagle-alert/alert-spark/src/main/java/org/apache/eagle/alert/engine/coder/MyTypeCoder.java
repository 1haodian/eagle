...
public class MyTypeCoder extends AtomicCoder<MyType> {
  ...
  @Override public void encode(MyType myType, OutputStream outputStream) throws IOException {
    STRING_CODER.encode(myType.getType(), outputStream);
    VAR_LONG_CODER.encode(myType.getValue(), outputStream);
  }

  @Override public MyType decode(InputStream inputStream) throws IOException {
